...
class TestBoris2():
    ...
    def test_boris2(self, username, email):
        ...
        # Esperar que  'username' sea visible  y despues interactua con él
...
if __name__ == "__main__":
    with open("results.txt", "w", encoding="utf-8") as file:  # sirve para especificar la codificacion UTF-8
        for i in range(100):
            test = TestBoris2()
            username = f"user{i+1}"
